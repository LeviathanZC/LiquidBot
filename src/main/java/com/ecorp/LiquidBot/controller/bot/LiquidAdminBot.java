...
import com.ecorp.LiquidBot.controller.handler.roles.admin.AdminResponseHandlerImpl;
...
public class LiquidAdminBot extends AbilityBot {
    ...
    private AdminResponseHandlerImpl responseHandler;


    @Autowired
    public LiquidAdminBot(Environment env) {
        super(env.getProperty("LIQUID_ADMIN_BOT_TOKEN"), "l_i_q_u_i_d_admin_bot");
        this.responseHandler = new AdminResponseHandlerImpl(silent, db);
    }
